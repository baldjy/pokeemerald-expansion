...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROSETHORN_CITY] = {MAP_GROUP(ROSETHORN_CITY), MAP_NUM(ROSETHORN_CITY), HEAL_LOCATION_ROSETHORN_CITY},
    [MAPSEC_DUSK_FOREST] = {MAP_GROUP(WAY_TO_DUSK_FOREST), MAP_NUM(WAY_TO_DUSK_FOREST), HEAL_LOCATION_NONE},
    [MAPSEC_KARIMA_DESERT] = {MAP_GROUP(KARIMA_DESERT), MAP_NUM(KARIMA_DESERT), HEAL_LOCATION_NONE},
    [MAPSEC_MOONLIGHT_LAKE] = {MAP_GROUP(MOONLIGHT_LAKE), MAP_NUM(MOONLIGHT_LAKE), HEAL_LOCATION_NONE},
    [MAPSEC_BLUE_PEARL_CITY] = {MAP_GROUP(BLUE_PEARL_CITY), MAP_NUM(BLUE_PEARL_CITY), HEAL_LOCATION_BLUE_PEARL_CITY},
    [MAPSEC_MARIGOLD_TOWN] = {MAP_GROUP(MARIGOLD_TOWN), MAP_NUM(MARIGOLD_TOWN), HEAL_LOCATION_MARIGOLD_TOWN},
    [MAPSEC_GRANDPORT_CITY] = {MAP_GROUP(GRANDPORT_CITY), MAP_NUM(GRANDPORT_CITY), HEAL_LOCATION_GRANDPORT_CITY},
    [MAPSEC_BENIMO_TOWN] = {MAP_GROUP(BENIMO_TOWN), MAP_NUM(BENIMO_TOWN), HEAL_LOCATION_BENIMO_TOWN},
    [MAPSEC_AMARYLLIS_CITY] = {MAP_GROUP(AMARYLLIS_CITY), MAP_NUM(AMARYLLIS_CITY), HEAL_LOCATION_AMARYLLIS_CITY},
    [MAPSEC_REDDUST_TOWN] = {MAP_GROUP(RED_DUST_TOWN), MAP_NUM(RED_DUST_TOWN), HEAL_LOCATION_RED_DUST_TOWN},
    [MAPSEC_ROUTE_401] = {MAP_GROUP(ROUTE401), MAP_NUM(ROUTE401), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_402] = {MAP_GROUP(ROUTE402), MAP_NUM(ROUTE402), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_403] = {MAP_GROUP(ROUTE403), MAP_NUM(ROUTE403), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_404] = {MAP_GROUP(ROUTE404), MAP_NUM(ROUTE404), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_405] = {MAP_GROUP(ROUTE405), MAP_NUM(ROUTE405), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_406] = {MAP_GROUP(ROUTE406), MAP_NUM(ROUTE406), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_601] = {MAP_GROUP(ROUTE601), MAP_NUM(ROUTE601), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_602] = {MAP_GROUP(ROUTE602), MAP_NUM(ROUTE602), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_603] = {MAP_GROUP(ROUTE603), MAP_NUM(ROUTE603), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_604] = {MAP_GROUP(ROUTE604), MAP_NUM(ROUTE604), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_605] = {MAP_GROUP(ROUTE605), MAP_NUM(ROUTE605), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_607] = {MAP_GROUP(ROUTE606), MAP_NUM(ROUTE606), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_608] = {MAP_GROUP(ROUTE607), MAP_NUM(ROUTE607), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_609] = {MAP_GROUP(ROUTE608), MAP_NUM(ROUTE608), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_610] = {MAP_GROUP(ROUTE609), MAP_NUM(ROUTE609), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_611] = {MAP_GROUP(ROUTE610), MAP_NUM(ROUTE610), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_614] = {MAP_GROUP(ROUTE614), MAP_NUM(ROUTE614), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_617] = {MAP_GROUP(ROUTE617), MAP_NUM(ROUTE617), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_701] = {MAP_GROUP(ROUTE701), MAP_NUM(ROUTE701), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_702] = {MAP_GROUP(ROUTE702), MAP_NUM(ROUTE702), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_703] = {MAP_GROUP(ROUTE703), MAP_NUM(ROUTE703), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_704] = {MAP_GROUP(ROUTE704), MAP_NUM(ROUTE704), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_705] = {MAP_GROUP(ROUTE705), MAP_NUM(ROUTE705), HEAL_LOCATION_NONE}
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ROSETHORN_CITY:
        return FlagGet(FLAG_VISITED_ROSETHORN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_ROSETHORN_CITY; mapSecId <= MAPSEC_REDDUST_TOWN; mapSecId++)
    {
